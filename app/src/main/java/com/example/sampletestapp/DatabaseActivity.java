    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( date.Year == 0 ) {
                    date = GetCurrDate(calendarDate);
                }
                // validating if the text fields are empty or not.
                if (courseName.isEmpty() && courseTracks.isEmpty() && courseDuration.isEmpty() && courseDescription.isEmpty() && date.Year != 0) {
                ...
                Log.e(getString(R.string.DB), date.DayOfMonth + "/" + date.Month + "/" + date.Year);
                ...
                date.Month = date.DayOfMonth = date.Year = 0;
            }
        });
    }
